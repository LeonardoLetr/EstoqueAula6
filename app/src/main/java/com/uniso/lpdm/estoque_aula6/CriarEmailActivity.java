...
public class CriarEmailActivity extends AppCompatActivity {
    ...
    public void onClickEnviar(View view){
        ...
        * o android posso perguntar qual aplicativo o usuario vai querer usar para tratar aquela informação*/
        ...
        EditText editTextNome = (EditText) findViewById(R.id.edtProduto);
        EditText editTextQtd = (EditText) findViewById(R.id.edtQtd);

        String nome = editTextNome.getText().toString();
        String qtd = editTextQtd.getText().toString();

        String mensagem = "Por favor, pedir para enviar " + qtd + " unidades do produto " + nome + " que está faltando em estoque.";
